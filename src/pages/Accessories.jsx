...
import AccessoriesShortHero from '../components/AccessoriesShortHero';
import AccessoriesTextList from '../components/AccessoriesTextList';
import AccessoriesWideBanners from '../components/AccessoriesWideBanners';
...
const Accessories = () => {
    ...
    const categoriesList = ['All', 'Watches', 'Bags', 'Jewelry', 'Sunglasses', 'Belts', 'Hats'];
    const sizes = ['OS']; // One Size

    useEffect(() => {
        let result = products.filter(p => ['Accessories', 'Jewelry'].includes(p.category)).slice(0, 12);
    ...
    return (
        <div className="shop-page-standard" style={{ backgroundColor: '#fff' }}>
            ...
            <AccessoriesShortHero />
            <AccessoriesTextList />
            <AccessoriesWideBanners />
